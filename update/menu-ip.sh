...
if [[ -f /etc/lukavpn/github/api && -f /etc/lukavpn/github/email && /etc/lukavpn/github/username ]]; then
   rec="OK"
else
    mkdir /etc/lukavpn/github > /dev/null 2>&1
fi
...
sleep 2
echo "$EMAIL1" > /etc/lukavpn/github/email
echo "$USERNAME1" > /etc/lukavpn/github/username
echo "$API1" > /etc/lukavpn/github/api
echo "ON" > /etc/lukavpn/github/gitstat
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
function resetipvps(){
clear
rm -f /etc/lukavpn/github/email
rm -f /etc/lukavpn/github/username
rm -f /etc/lukavpn/github/api
rm -f /etc/lukavpn/github/gitstat
echo "OFF" > /etc/lukavpn/github/gitstat
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1│${NC} [INFO] PM : @jrtunnelssh t.me/lukavpn"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}              • WWW.lukavpn.lol •            $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
GITREQ=/etc/lukavpn/github/gitstat
if [ -f "$GITREQ" ]; then
    cekk="ok"
else 
    mkdir /etc/lukavpn/github
    touch /etc/lukavpn/github/gitstat
    echo "OFF" > /etc/lukavpn/github/gitstat
fi

stst1=$(cat /etc/lukavpn/github/gitstat)
if [ "$stst1" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│${NC} ${COLBG1}               • REGISTER IPVPS •              ${NC} $COLOR1│$NC"
...
stst=$(cat /etc/lukavpn/github/gitstat)
if [ "$stst" = "ON" ]; then
APIOK="CEK API"
rex="viewapi"
else
